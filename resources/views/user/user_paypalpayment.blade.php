    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <h4> <strong>Base Fee: </strong> {{$events->amount}} PHP </h4>
                <h4> <strong>Online Transaction Fee: </strong> 150 PHP </h4>
                <h4> <strong>Total Amount Due: </strong> {{$events->amount + 150}} PHP </h4>
                <br>
            ...
            <div class="box-footer">
                    ...
                    <p align="right">
                    <button type="button" class="btn btn-primary mb-2" onclick="window.location='{{url("user/modepayment/". $events->id)}}'"><i class="fa fa-close"></i>
                        Back
                    </button>
                </p>
            </div>
