                    ...
                    <div class="col-md-12">
                        <div class="box1">
                            <div class="row">
                                    ...
                                    <div class="box-body" style="color: rgb(51, 51, 51); font-family: &quot;Source Sans Pro&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;">
                                        <div class="row site-box-view" style="margin-left: -10px; margin-right: -10px; border: none;">
                                            <div class="col-md-6" style="width: 553px; font-size: 15px;">
                                                <h5 style="font-family: &quot;Source Sans Pro&quot;, sans-serif; font-size: 20px; text-transform: uppercase;">THANK YOU FOR SUBMITTING YOUR REGISTRATION!</h5>Kindly send your payment to the Organizer's account as follows:&nbsp;<br>
                                                <br>
                                                <br>
                                                <label> BDO </label><br>
                                                ...
                                                <br>
                                                <br>
                                                <p style="font-size: 25px; font-weight: bold;">Amount to be paid:&nbsp;{{$events->amount}} PHP</p>
                                ...
                                <div class="col-md-6">
                                    <br>
                                    <form action="{{url('/user/dobankdeposit/'. $events->id)}}" method="post" enctype='multipart/form-data'>
                                        {{ csrf_field() }}
