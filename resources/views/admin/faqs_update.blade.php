      ...
      <div class="content-wrapper">
        ...
        -------------------------->
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="{{ url('admin/doupdatefaq/'. $faqs->id) }}" method="post">
                {{ csrf_field() }}
                <br>
                <div class="form-group">
                  <label for="formGroupExampleInput">Name</label>
                  <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Name" name="title" value="{{$faqs->title}}">
                </div>
                <div class="form-group">
                  <label for="formGroupExampleInput2">Description</label>
                  <textarea class="form-control summernote" name="description">{{$faqs->description}}</textarea>
                </div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        Do you really want to update this FAQ?
                      </div>
