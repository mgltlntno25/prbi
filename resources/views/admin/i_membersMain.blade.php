...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-users"></i> Insured Members</a></li>
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><button type="button" class="btn btn-info" data-placement="top" title="View Member" onclick="window.location='{{url("admin/insured_members/" . $member->id)}}'"><i class="fa fa-eye"></i> </button>
                @if($member->status == 'active')
                <button type="button" class="btn btn-danger" data-placement="top" title="Deactivate Member" data-toggle="modal" data-target="#statusModal{{ $member->id }}"><i class="fa fa-close"></i>
                </button>
                @elseif($member->status == 'inactive')
                <button type="button" class="btn btn-success" data-placement="top" title="Activate Member" data-toggle="modal" data-target="#statusModal{{ $member->id }}"><i class="fa fa-check"></i>
                </button>
                @endif

                <!-- Modal -->
                <div class="modal" id="statusModal{{ $member->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
