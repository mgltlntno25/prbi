          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="event-venue blurry-black-text" style="font-size: 15px; text-transform: uppercase; letter-spacing: 1px; color: rgb(72, 72, 72); font-family: &quot;Source Sans Pro&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;"><span class="fa fa-map-marker" aria-hidden="true" style="transform: translate(0px, 0px);"></span>&nbsp;&nbsp;<strong>Location : </strong> {{$events->location}}</div>
                <div class="event-start-date blurry-black-text" style="font-size: 15px; text-transform: uppercase; letter-spacing: 1px; color: rgb(72, 72, 72); font-family: &quot;Source Sans Pro&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;"><span class="fa fa-calendar" aria-hidden="true" style="transform: translate(0px, 0px);"></span>&nbsp;&nbsp;<strong>Event Date:</strong> {{$events->event_date}}</div>
                <div class="event-start-date blurry-black-text" style="font-size: 15px; text-transform: uppercase; letter-spacing: 1px; color: rgb(72, 72, 72); font-family: &quot;Source Sans Pro&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;"><span class="fa fa-calendar" aria-hidden="true" style="transform: translate(0px, 0px);"></span>&nbsp;&nbsp;<strong>Start of Registration : </strong>{{$events->start_reg}}</div>
                <div class="event-start-date blurry-black-text" style="font-size: 15px; text-transform: uppercase; letter-spacing: 1px; color: rgb(72, 72, 72); font-family: &quot;Source Sans Pro&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;"><span class="fa fa-calendar" aria-hidden="true" style="transform: translate(0px, 0px);"></span>&nbsp;&nbsp;<strong>End of Registration :</strong>{{$events->end_reg}}</div>
                <div class="event-start-date blurry-black-text" style="font-size: 15px; text-transform: uppercase; letter-spacing: 1px; color: rgb(72, 72, 72); font-family: &quot;Source Sans Pro&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;"><span class="fa fa-money" aria-hidden="true" style="transform: translate(0px, 0px);"></span>&nbsp;&nbsp;<strong> Amount : {{$events->amount}} </strong></div>
